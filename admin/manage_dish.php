  ...
  if(mysqli_num_rows(mysqli_query($con,$sql))>0){
    ...
    if($id==''){
      if($type!='image/jpeg' && $type!='image/png'){
         $image_error="Inavalid image format";
      }else{
...
<div class="row">
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="error mt8" required><?php echo $msg?></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="dish_detail" class="form-control" placeholder="Dish Detail"></textarea>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="error mt8" required><?php echo $image_error?></div>
                    </div>
                    ...
                    <div class="form-group" id="dish_box1">
                     ...
                     <?php } else{
                       ...
                       <div class="row mt8">
                         ...
                         <?php if($ii!=1){?>
                          <div class="col-2"><button type="button" class="btn btn-primary mr-2" onclick="remove_more_new('<?php echo $dish_details_row['id']?>')">Remove</button></div>
                         <?php } ?>
                       </div>
                     <?php 
                      $ii++;
                    ...
                    <button type="button" class="btn btn-primary mr-2" onclick="add_more()">Add More</button>
                  </form>
                </div>
              </div>
            </div>      
     ...
     <script>
       function add_more(){
         ...
         var html='<div class="row mt8" id="box'+add_more+'"><div class="col-4"><input type="text" class="form-control"  placeholder="Attribute" name="attribute[]" required></div><div class="col-3"><input type="text" class="form-control"  placeholder="Price" name="price[]" required></div><div class="col-3"><select required name="status[]" class="form-control"><option value="">Select Status</option><option value="1">Active</option><option value="0">Deactive</option></select></div><div class="col-2"><button type="button" class="btn btn-primary mr-2" onclick=remove_more("'+add_more+'")>Remove</button></div></div>';
