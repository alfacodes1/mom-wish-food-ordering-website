...
$website_close=isset($getSetting) ? $getSetting['website_close'] : null;
$website_close_msg=isset($getSetting) ? $getSetting['website_close_msg'] : null;
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-4">
                            <div class="logo">
                                <a href="<?php echo FRONT_SITE_PATH?>">
                                    <img alt="" src="<?php echo FRONT_SITE_PATH?>assets/img/logo/logo.png" width="350px">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="header-cart">
                                    ...
                                    <div class="shopping-cart-content">
                                        ...
                                        <div class="shopping-cart-total">
                                            <h4>Total : <span class="shop-total" id="shopTotal">Rs.<?php echo $totalPrice?></span></h4>
                                        </div>
