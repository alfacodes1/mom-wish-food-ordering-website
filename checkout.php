<?php 
include("header.php");
if($website_close_msg==1){
    redirect(FRONT_SITE_PATH.'home');
}
$cartArr=getUserFullCart();
if(count($cartArr)>0){}else{
    redirect(FRONT_SITE_PATH.'home');
}
...
if(isset($_POST['place_order'])){
    ...
    $sql="insert into order_master(user_id,name,email,mobile,address,total_price,order_status,payment_status,added_on) values('".$_SESSION['FOOD_USER_ID']."','$checkout_name','$checkout_email','$checkout_mobile','$checkout_address','$totalPrice','1','pending','$added_on')";
                                                    ...
                                                    <div class="checkout-login">
                                                        ...
                                                        <form method="post" id="frmLogin">
                                                            ...
                                                            <div class="checkout-login-btn">
                                                                <button type="submit" class="my_btn" id="login_submit">Login</button>
