...
if($type=='register'){
    ...
    if($check>0){
        ...
        $rand_str=rand_str();
        mysqli_query($con,"insert into user(name,email,password,mobile,status,email_verify,added_on,rand_str) values('$name','$email','$new_password','$mobile','1','0','$added_on','$rand_str')");
